...
<c:if test="${param.type == 'EXPERIENCE' || param.type == 'EDUCATION'}">
    ...
    <input type='text' name='${param.type}_startDate00' size='10' value='' placeholder='Дата начала'></br>
...
<c:if test="${param.type == 'ACHIEVEMENT' || param.type == 'QUALIFICATIONS'}">
     <table>
       <tr>
         ...
         <td>
           <textarea name='${param.type}' placeholder="Для маркированного текста используйте enter" rows='5' cols='100'></textarea>
         </td>
       </tr>
     </table>
</c:if>
