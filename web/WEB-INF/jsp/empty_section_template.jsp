...
<c:if test="${param.type == 'EXPERIENCE' || param.type == 'EDUCATION'}">
    <input type='text' name='${param.type}_companyName0' size='30' value='' placeholder='Название Организации'> </br>
    <input type='text' name='${param.type}_webSite0' size='50' value='' placeholder='Сайт Организации'> </br>
